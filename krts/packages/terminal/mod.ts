    ...
    vite.mergeConfig(
      {
        ...
        build: {
          ...
          rollupOptions: {
            ...
            external: ['vue', 'vue-router', '@krts/terminal'],
            output: {
              format: 'module',
        ...
        resolve: {
          alias: {
            'vue-i18n': '@krts/terminal',
            '@krts/components': '@krts/terminal',
          },
        },
        define: {
  ...
  return (await vite.build({
    ...
    resolve: {
      alias: {
        ...
        '@krts/terminal': base + '/terminal.js',
        ...(isEndTerminal
          ? {
