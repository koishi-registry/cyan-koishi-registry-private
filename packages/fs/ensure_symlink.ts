...
// https://jsr.io/@std/fs/1.0.16/ensure_symlink.ts
import { dirname, resolve } from "@kra/path";
// import { ensureDir, ensureDirSync } from "./ensure_dir.ts";
// import { getFileInfoType, type PathType } from "./_get_file_info_type.ts";
import { toPathString } from "@kra/path/to_path_string";
// import { lstat } from 'node/path'
